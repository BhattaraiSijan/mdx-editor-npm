...
import { MapContextProvider, useMapContext } from '@nasa-impact/mdx-editor-utils';
import dynamic from 'next/dynamic';
import { LexicalNode } from 'lexical';
import { TextInput, Label, Button, DatePicker } from '@trussworks/react-uswds';
import { MapProps } from '@nasa-impact/mdx-editor-core';
import { useMdastNodeUpdater } from '@mdxeditor/editor';
import { DEFAULT_MAP_PROPS } from '@nasa-impact/mdx-editor-ui';
import { InputField } from '@nasa-impact/mdx-editor-utils';
import { ClientMapBlock } from '@nasa-impact/mdx-editor-maps';
...
const MapEditorWithPreview: React.FC<any> = (props) => {
  ...
  const initialMapProps = () => {
    try {
      // Check for mdastNode in different locations based on how it's passed
